...
plt.hist(x,bins=80,normed=True,color='r',alpha=0.5,edgecolor='k',label='Numerical results')
plt.hist(y,bins=80,normed=True,color='b',alpha=0.5,edgecolor='k',label='Numerical results')
