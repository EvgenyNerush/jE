...
# approximately 500 bins are requared by plt.hist to reproduce the picture given by histogram_1D
# with 10 bins. However, if one uses 500 bins of the same width, the resulting dN/dx would be
# noizy.
